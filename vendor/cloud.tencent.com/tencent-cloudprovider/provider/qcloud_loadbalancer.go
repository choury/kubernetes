...
func (self *QCloud) GetLoadBalancer(ctx context.Context, clusterName string, apiService *v1.Service) (status *v1.LoadBalancerStatus, exists bool, err error) {
...
func (self *QCloud) ensureLBCreate(clusterName string, apiService *v1.Service, hosts []string) error {
	...
	if queryRsp != nil && queryRsp.LBType != toCreateLBType {
		...
		if err := self.EnsureLoadBalancerDeleted(context.Background(), clusterName, apiService); err != nil {
			return err
		}
	}
...
func (self *QCloud) ensureLoadBalancer(clusterName string, apiService *v1.Service, hosts []*v1.Node) (*v1.LoadBalancerStatus, error) {
	...
	err = self.UpdateLoadBalancer(context.Background(), clusterName, apiService, hosts)
	if err != nil {
...
func (self *QCloud) EnsureLoadBalancer(ctx context.Context, clusterName string, apiService *v1.Service, hosts []*v1.Node) (*v1.LoadBalancerStatus, error) {
...
func (self *QCloud) UpdateLoadBalancer(ctx context.Context, clusterName string, apiService *v1.Service, hosts []*v1.Node) error {
...
func (self *QCloud) EnsureLoadBalancerDeleted(ctx context.Context, clusterName string, apiService *v1.Service) error {
