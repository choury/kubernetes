...
type InternalContainerLifecycle interface {
	...
	PostUpdateContainer(Pod *v1.Pod, container *v1.Container, containerID string) error
...
func (i *internalContainerLifecycleImpl) PostUpdateContainer(pod *v1.Pod, container *v1.Container, containerID string) error {
	if utilfeature.DefaultFeatureGate.Enabled(kubefeatures.CPUManager) {
